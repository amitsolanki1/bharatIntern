    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-md-8">
                ...
                <div class="card mt-2" >
                          <img src="<?php echo e(asset('images/'.$blog->image)); ?>" height="400px" width="auto" class="card-img-top" alt="Image">
                          <div class="card-body">
                            <h5 class="card-title"><?php echo e($blog->title); ?><span class="float-right ml-3" style="font-size:10px;"><?php echo e(date('D M, Y h:i a',strtotime($blog->created_at))); ?> /  posted by: <?php echo e($blog->posted_by); ?></span></h5>
...
</html><?php /**PATH D:\xampp\htdocs\blog\resources\views/index.blade.php ENDPATH**/ ?>